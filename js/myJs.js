...
let inputRecord = document.createElement('input'); // создаём поле для рекорда
document.body.appendChild(inputRecord); // добавляем в body
// задаём стили полю
inputRecord.style.cssText = ` 
    margin: auto;
    margin-bottom: 40px;
    font-size: 16px;
    display: block;`;
...
let scoreRecord = 0; // переменная для рекорда
